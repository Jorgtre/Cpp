...
const D3DCOLOR Pink = D3DCOLOR_ARGB(255, 255, 33, 203);					//D3DCOLOR_ARGB(255, 255, 192, 203)
...
namespace d3dVertex
{
	...
	struct VertexPosTex3D
	{
		VertexPosTex3D(){}
		VertexPosTex3D(float _x, float _y, float _z, float _u, float _v)
		{
			x = _x;
			y = _y;
			z = _z;
